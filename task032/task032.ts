    ...
    // List 1
    let current_Users:string [] = ["Awais", "Ahmed", "Aslam", "Qasim", "Muneer"];
    // List 2
    let new_Users:string [] = ["Ali", "Rafiu", "Faizan", "Awais", "Ahmed"];
    // convert current users into lowerCase
    let case_Incensitive: string [] = current_Users.map(user => user.toLowerCase());
